...
class ClientOrdersAdapter(private val deleteAction: (id: Long) -> Unit, private val finishAction: (id: Long) -> Unit, private val showAction: (lat: Double, lang: Double) -> Unit)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClientOrderHolder {
        return ClientOrderHolder(LayoutInflater.from(parent.context).inflate(R.layout.viewholder_client_order,
                parent, false), deleteAction, finishAction, showAction)
    }
